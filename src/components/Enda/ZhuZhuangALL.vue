<template>
  <div id="ZhuZhuangALL" style="width: 100%;height: 330px;"></div>
</template>
...
export default {
  ...
  data () {
    return {
      superall2018: [1749,1832],
      superall2019: [1506,1677],
      superall2020: [697,1183],
    }
  },
  ...
  methods: {
    ...
    getEchart () {
      ...
      let myChart = echarts.init(document.getElementById('ZhuZhuangALL'), 'dark');
      let itemStyle = {
        normal: {
          label: {
            show: true, //开启显示
