<template>
  <div>
    <div id="main1" style="width: 50%;height: 330px;"></div>
    <div id="main2" style="width: 50%;height: 340px;"></div>
    <div id="main3" style="width: 50%;height: 350px;"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    getEchart () {
      ...
      let myChart1 = echarts.init(document.getElementById('main1'), 'blue');
