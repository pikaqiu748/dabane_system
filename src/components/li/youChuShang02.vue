<template>
  <div class="wrap-container sn-container">
    ...
    <div class="sn-content">
      <div class="sn-title">近三年初中班额分布情况
      ...
      <div class="sn-body">
        <div class="wrap-container">
          <div id="chu01" class="chartsdom"></div>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    chuShow () {
      var myChart = echarts.init(document.getElementById('chu01'))
      var option = {
        legend: {
          left: 'center',
          top: 'bottom',
        ...
        dataset: {
          source: [
            ...
            ['大班额：', 23.02, 45.85, 9.99],
            ['超大班额：', 11.11, 33.88, 24.24],
          ]
        },
        xAxis: [
          {
