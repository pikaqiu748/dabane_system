...
<script>
import { getSuperBigGradeAll2020 } from '../../api/request'
...
export default {
  ...
  mounted() {
    this.getSuperBigGradeAll2020();
  },
  methods: {
    getSuperBigGradeAll2020() {
      getSuperBigGradeAll2020().then(res => {
