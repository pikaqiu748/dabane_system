  ...
  methods: {
    ...
    getEchart () {
      ...
      this.dataMap.dataType = this.dataFormatter({
        2: [888,222,563,42,560,246,258,61,66,0,77,233,1,55,5,22],
        1: [369,55,301,22,222,66,546,33,88,300,200,75,85,22,1,33],
        0: [269,58,369,1,333,200,114,38,80,228,299,199,88,22,1,66],
      });
