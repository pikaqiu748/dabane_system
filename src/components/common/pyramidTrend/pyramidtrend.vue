...
<template>
  <div class="wrap-container sn-container">
    ...
    <div class="sn-content">
      <div class="sn-title">市州小学近三年超大班额数量对比分布图</div>
      <div class="sn-body">
  ...
  methods: {
    ...
    getEchart () {
      ...
      this.dataMap.dataType = this.dataFormatter({
        2: [124, 145, 261, 54, 195, 131, 150, 39, 11, 40, 23, 51, 45, 88, 76, 86, 45],
        1: [136, 159, 205, 41, 306, 7, 77, 101, 24, 34, 8, 15, 14, 9, 34, 65, 45],
        0: [118, 128, 220, 47, 92, 14, 9, 11, 113, 61, 11, 22, 33, 5, 54, 66, 34],
      });
