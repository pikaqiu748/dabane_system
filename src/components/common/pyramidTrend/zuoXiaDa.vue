  ...
  methods: {
    ...
    getEchart () {
      ...
      this.dataMap.dataType = this.dataFormatter({
        2: [39.88, 35.13, 43.7, 19.08, 47.63, 37.25, 27.03, 30.29, 15.37, 12.11, 37.22, 7.2, 7.9, 18.78, 12.25, 16.79],
        1: [34.18, 35.97, 35.39, 27.75, 34.91, 39.72, 29.14, 24.63, 15.59, 11.56, 30.19, 21.18, 4.48, 9.68, 21.85, 13.66],
        0: [22.31, 25.74, 25.29, 27.95, 20.43, 25.48, 38.00, 29.68, 16.02, 10.6, 26.43, 15.69, 7.00, 24.53, 23.69, 12.78],
      });
