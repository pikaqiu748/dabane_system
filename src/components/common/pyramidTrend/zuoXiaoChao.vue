...
<template>
  <div class="wrap-container sn-container">
    ...
    <div class="sn-content">
      <div class="sn-title">近三年各省份小学班额比例分布
  ...
  methods: {
    ...
    getEchart () {
      ...
      this.dataMap.dataType = this.dataFormatter({
        // ['恩施州', '孝感市', '仙桃市',  '随州市', '潜江市', '襄阳市', '黄冈市', '鄂州市','十堰市', '武汉市','荆门市', '荆州市', '天门市','黄石市', '咸宁市', '宜昌市'],
        2: [6.22,4.66,6.22,2.33,1.11,2.22,1.99,0.77,3.66,1.00,1.33,2.66,0.01,0.88,1.22,0.02],
        1: [6.88,5.44,1.11,0.22,0.44,8.22,1.33,2.55,4.22,1.33,1.22,2.55,2.66,2.11,6.88,1.01],
        0: [5.22,1.55,2.88,4.66,5.77,4.68,5.88,4.66,4.00,1.22,0.11,0.50,6.44,2.55,1.66,1.25],
      });
      ...
      this.option = {
        baseOption: {
          ...
          xAxis: [{
            ...
            data: ['恩施州', '孝感市', '仙桃市', '随州市', '潜江市', '襄阳市', '黄冈市', '鄂州市', '十堰市', '武汉市', '荆门市', '荆州市', '天门市', '黄石市', '咸宁市', '宜昌市'],
            splitLine: {
              show: false
            },
            axisTick: {
