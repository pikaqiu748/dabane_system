  ...
  methods: {
    ...
    getEchart () {
      ...
      this.dataMap.dataType = this.dataFormatter({
        2: [166, 177, 777, 133, 520, 275, 637, 81, 395, 356, 335, 520, 111, 78, 3, 45, 1],
        1: [567, 132, 470, 65, 659, 175, 789, 43, 388, 599, 666, 377, 256, 40, 0, 40, 88],
        0: [781, 88, 336, 0, 565, 165, 815, 39, 323, 378, 502, 248, 176, 89, 3, 28, 110],
      });
