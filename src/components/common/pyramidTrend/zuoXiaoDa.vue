...
<template>
  <div class="wrap-container sn-container">
    ...
    <div class="sn-content">
      <div class="sn-title">近三年各市州小学班额比例分布
  ...
  methods: {
    ...
    getEchart () {
      ...
      this.dataMap.dataType = this.dataFormatter({
        // ['仙桃市', '孝感市', '恩施州', '潜江市', '襄阳市', '黄冈市', '随州市', '十堰市', '武汉市', '荆门市', '咸宁市', '荆州市', '宜昌市', '天门市', '鄂州市', '黄石市'],
        2: [11.25,33.72,22.11,19.95,23.11,22.88,22.35,25.88,7.22,1.55,8.77,9.88,7.33,4.66,7.44,1.33],
        1: [9.77,21.75,22.22,23.55,22.66,8.11,22.22,8.11,1.36,5.55,16.55,6.22,1.44,6.22,4.23,1.01],
        0: [22.11,22.55,13.22,13.44,22.25,4.22,23.12,5.44,3.77,6.44,6.77,22.22,3.11,11.21,3.22,9.11],
      });
