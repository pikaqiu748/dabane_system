...
<template>
  <div class="wrap-container sn-container">
    ...
    <div class="sn-content">
      <div class="sn-title">近三年各省份初中班额数量分布
  ...
  methods: {
    ...
    getEchart () {
      ...
      this.dataMap.dataType = this.dataFormatter({
        // ['孝感市', '恩施州', '黄冈市', '鄂州市','神农架','随州市', '襄阳市', '仙桃市', '咸宁市', '十堰市', '荆州市', '武汉市', '潜江市', '荆门市', '黄石市', '宜昌市', '天门市'],
        2: [755, 765, 207, 28, 0, 47, 102, 15, 44, 645, 25, 35, 645, 78, 876, 31, 31],
        1: [70, 132, 423, 423, 0, 17, 221, 25, 139, 64, 125, 31, 2, 0, 30, 34, 534],
        0: [62, 423, 138, 234, 1, 49, 260, 25, 534, 645, 645, 26, 97, 312, 312, 75, 39],
      });
      ...
      this.option = {
        baseOption: {
          ...
          xAxis: [{
            ...
            data: ['孝感市', '恩施州', '黄冈市', '鄂州市', '神农架', '随州市', '襄阳市', '仙桃市', '咸宁市', '十堰市', '荆州市', '武汉市', '潜江市', '荆门市', '黄石市', '宜昌市', '天门市'],
            splitLine: {
              show: false
            },
            axisTick: {
