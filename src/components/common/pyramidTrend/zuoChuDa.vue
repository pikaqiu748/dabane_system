    ...
    <div class="sn-content">
      ...
      <div class="sn-body">
        <div class="wrap-container">
          <div class="chartsdom" id="zuoxia01"></div>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    getEchart () {
      let myChart = echarts.init(document.getElementById('zuoxia01'));
      let itemStyle = {
      ...
      this.dataMap.dataType = this.dataFormatter({
        2: [33.77, 25.52, 28.12, 15.54, 19.90, 15.83, 17.71, 16.66, 15.88, 14.55, 11.99, 7.05, 4.90, 8.10, 4.56, 0.82, 0.22],
        1: [33.22, 17.71, 16.51, 8.15, 22.88, 12.99, 32.66, 7.33, 18.39, 39.62, 19.88, 9.62, 13.45, 5.45, 0.00, 1.66, 12.67],
        0: [18.18, 11.99, 15.84, 0.00, 22.33, 13.13, 25.52, 9.44, 15.33, 20.49, 18.72, 6.68, 8.55, 7.09, 3.77, 1.88, 14.89],
      });
      ...
      this.option = {
        baseOption: {
          ...
          xAxis: [{
            ...
            data: ['黄冈市', '仙桃市', '孝感市', '鄂州市', '恩施州', '随州市', '襄阳市', '潜江市', '十堰市', '咸宁市', '荆州市', '武汉市', '黄石市', '荆门市', '神农架', '宜昌市', '天门市'],
            splitLine: {
              show: false
            },
            axisTick: {
