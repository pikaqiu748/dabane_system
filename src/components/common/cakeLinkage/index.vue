...
<template>
  <div class="wrap-container sn-container">
    ...
    <div class="sn-content">
      <div class="sn-title">近三年市州大班额情况总览
        <el-button type="primary" class="xiaoxue-btn">大班额</el-button>
        <el-button type="primary" class="chuzhong-btn" @click="changechao">超大班额</el-button>
      </div>
      <div class="sn-body">
        <div class="wrap-container">
          <div class="chartsdom" id="da"></div>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  data () {
    return {
      ...
      dataMap: {},
      Xaxis:
        ['咸宁市', '仙桃市', '十堰市', '荆州市', '孝感市', '神农架', '恩施州', '鄂州市', '武汉市', '潜江市', '荆门市', '天门市', '黄冈市', '宜昌市', '黄石市', '随州市', '襄阳市']
    }
  },
  mounted () {
    this.getEchart()
  ...
  methods: {
    ...
    getEchart () {
      let myChart = echarts.init(document.getElementById('da'));
      let itemStyleIT = {
        color: '#2867a8'
      }
      // let itemStyleIT = {
      ...
      this.option = {
        ...
        options: [{
          series: [
            {
              // ['咸宁', '仙桃', '十堰', '荆州', '孝感', '神农架', '恩施州', '鄂州', '武汉', '潜江', '荆门', '天门', '黄冈', '宜昌', '黄石', '随州', '襄阳'];
              data: [
                {
                  name: '咸宁市',
