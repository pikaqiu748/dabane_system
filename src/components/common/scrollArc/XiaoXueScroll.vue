...
<template>
  <div class="wrap-container sn-container">
    ...
    <div class="sn-content">
      <div class="sn-title">市州超大班额比例增长分布图
        <!-- <el-button type="primary" class="xiaoxue-btn">小学</el-button> -->
        <!-- <el-button type="primary" class="chuzhong-btn" @click="change3">初中</el-button> -->
      </div>
      <div class="sn-body">
        <div class="wrap-container">
          <div class="chartsdom" id="xiaoxue"></div>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  data () {
    return {
      ...
      percentage: [],
      barnum1: [],
      xname1: ['咸宁', '仙桃', '十堰', '荆州', '孝感', '神农架', '土家族', '鄂州', '武汉', '潜江', '荆门', '天门', '黄冈', '宜昌', '黄石', '随州', '襄阳'],
      linenum1: {},
      num1: [],
      result1: 0,
      percentage1: [],
      xiaochupercentage: [-1.80,1.26,0.74,-3.22,1.99,-0.01,0.29,0.09,-0.18,0.13,-0.97,-0.47,3.08,-1.01,-0.80,0.69,0.20]
    }
  },
  methods: {
    change3 () {
    ...
    getEcharts () {
      var myChart = echarts.init(document.getElementById('xiaoxue'));
      let option = {
        tooltip: {
          trigger: 'axis',
          showContent: false,
