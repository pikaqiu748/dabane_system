...
export default {
  ...
  data () {
    return {
      listData: [{
        title: '小学大班额整体上较2019较小幅度增加',
        date: '全省',
        hot: '1.46%'
      },
      {
        title: '咸宁市的小学大班额比例消除幅度最大',
        date: '咸宁市',
        hot: '8.47%'
      }, {
        title: '天门市的初中大班额消除幅度最大',
        date: '天门市',
        hot: '12.30%'
      }, {
        title: '仙桃市的小学大班额现象最严重',
        date: '仙桃市',
        hot:  '23.17%'
      }, {
        title: '初中大班额问题呈逐渐消除的态势',
        date: '全省',
        hot: '-1.59%'
      },{
        title: '黄冈市的初中大班额现象较为严重  ',
        date: '黄冈市',
        hot: '31.77%'
      },
      {
        title: '潜江市的初中大班额消除幅度最小',
        date: '潜江市',
        hot: '-13.15%'
      },
      {
      ...
      {
        title: '仙桃市大班额比例消除幅度呈负增长趋势  ',
        date: '仙桃市',
        hot: '-14.24%'
      },
      {
        title: '咸宁市小学大班额消除数量最大',
        date: '咸宁市',
        hot: '463个'
      },
      ]
