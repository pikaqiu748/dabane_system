...
<template>
  <div class="wrap-container sn-container">
    ...
    <div class="sn-content">
      <div class="sn-title">各市州小学班额消除比例情况
...
export default {
  ...
  data () {
    return {
      ...
      percentage: [],
      barnum1: [],
      xname1: ['仙桃', '黄冈', '孝感', '十堰', '潜江', '随州', '宜昌', '恩施', '武汉', '荆门', '鄂州', '荆州', '襄阳', '黄石', '天门', '咸宁'],
      linenum1: {},
      num1: [],
      result1: 0,
      percentage1: [],
      xiaochupercentage: [-10.98, -3.013, -9.11, -3.25, -3.66, -4.22, -4.01, -0.22, -1.34, -0.99, -1.02, 1.36, 3.14, 6.11, 2.99, 9.99]
    }
  },
  methods: {
    change3 () {
