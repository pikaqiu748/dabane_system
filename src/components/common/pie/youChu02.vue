...
export default {
  ...
  data () {
    return {
      ...
      timer: null,
      barnum: [],
      xname: ['孝感', '随州', '鄂州', '黄冈', '恩施州', '十堰', '荆门', '武汉', '宜昌', '潜江', '仙桃', '黄石', '天门', '荆州', '襄阳', '咸宁'],
      linenum: {},
      num: [],
      result: 0,
      percentage: [],
      ...
      result1: 0,
      percentage1: [],
      xiaochupercentage: [-13.69, -33.18, -12.21, -22.44, -15.77, -35.22, -7.07, -0.08, 15.00, 
      2.15, 3.08, 5.88, 5.54, 7.32, 7.66, 8.88]
    }
  },
  methods: {
    change3 () {
