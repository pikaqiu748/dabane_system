...
export default {
  ...
  data () {
    return {
      ...
      timer: null,
      barnum: [],
      xname: ['仙桃市', '恩施州', '孝感市', '随州市', '潜江市', '黄冈市', '鄂州市', '武汉市', '荆门市', '十堰市', '宜昌市', '黄石市', '天门市', '荆州市', '襄阳市', '咸宁市'],
      linenum: {},
      num: [],
      result: 0,
      percentage: [],
      ...
      result1: 0,
      percentage1: [],
      xiaochupercentage: [-2.81, -3.58, -5.07, -4.44, -2.01, -2.27, -2.15, -0.56, -0.47, -0.24, 0, 2.4, 3.92, 4.36, 5.26, 10.69]
    }
  },
  methods: {
    change3 () {
