...
<template>
  <div class="wrap-container sn-container">
    ...
    <div class="sn-content">
      <div class="sn-title">各区域类型小学班额消除情况
      ...
      <div class="sn-body">
        <div class="wrap-container">
          <div class="chartsdom" id="lineh2"></div>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  data () {
    return {
      ...
      timer: null,
      barnum: [],
      xname: ['主城区', '城乡结合区', '镇中心区', '镇乡结合区', '特殊区域', '乡中心区', '村庄'],
      linenum: {},
      num: [],
      result: 0,
      percentage: [],
      ...
      result1: 0,
      percentage1: [],
      xiaochupercentage: [0.0, 0.2, -0.1, -0.3, -9.4, -0.5, -0.2]
    }
  },
  methods: {
    change3 () {
    ...
    getEcharts () {
      var myChart = echarts.init(document.getElementById('lineh2'))
      let option = {
        tooltip: {
          trigger: 'axis',
          showContent: false,
